...
{
  $ver = '1.0.0';
  wp_enqueue_style('theme-style', get_stylesheet_directory_uri() . '/styles/css/main.css', $ver, 'all');
  wp_enqueue_script('theme-script', get_stylesheet_directory_uri() . '/js/main.js', array('jquery'), $ver, true);
}
  ...
  if (function_exists('acf_register_block_type')) {
    acf_register_block_type(array(
      ...
      'enqueue_assets' => function () {
        wp_enqueue_style('block-slider', get_stylesheet_directory_uri() . '/parts/blocks/slider/styles/css/style.css');
        wp_enqueue_script('slick-min', get_stylesheet_directory_uri() . '/parts/blocks/slider/slick/slick.min.js', array(), '', true);
        wp_enqueue_script('block-image-text', get_stylesheet_directory_uri() . '/parts/blocks/slider/js/script.js', array('jquery', 'slick-min'), '', true);
      },
      'example'           => array(
        'attributes' => array(
          'mode' => 'preview',
    ...
    acf_register_block_type(array(
      ...
      'enqueue_style'     => get_stylesheet_directory_uri() . '/parts/blocks/image-text/styles/css/style.css',
      'enqueue_script'    => get_stylesheet_directory_uri() . '/parts/blocks/image-text/js/script.js',
      'example'           => array(
        'attributes' => array(
          'mode' => 'preview',
          'data' => array(
    ...
    acf_register_block_type(array(
      ...
      'enqueue_assets' => function () {
        wp_enqueue_style('block-accordion', get_stylesheet_directory_uri() . '/parts/blocks/accordion/styles/css/style.css');
        wp_enqueue_script('jquery-ui', '//code.jquery.com/ui/1.13.3/jquery-ui.js', array(), '', true);
        wp_enqueue_script('block-accordion', get_stylesheet_directory_uri() . '/parts/blocks/accordion/js/script.js', array('jquery', 'jquery-ui'), '', true);
      },
      'example' => array(
        'attributes' => array(
          'mode' => 'preview',
